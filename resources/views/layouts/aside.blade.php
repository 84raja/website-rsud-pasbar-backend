<aside class="card sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    {{-- <div class="card"> --}}
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/area-admin/profile">
                <img src="{{asset('/assets/img/rsud-logo.jpg')}}" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">RSUD PASBAR</span>
            </a>
        </div>
        ...
        <div>
            <ul class="collapse navbar-collapse navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('polyclinic*')?'active':'' }}"
                        href="{{ route('polyclinic.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Poliklinik & Instalasi Medis</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{request()->routeIs('schedule*')?'active':''}}"
                        ...
                        <span class="nav-link-text ms-1">Jadwal Poliklinik</span>
                    </a>
                </li>
